# [hexo_blog](https://hexo.darrelltw.site/?utm_source=github&utm_medium=referral)
...
## [GTM - Handle comma and period - 處理價格的小數點和逗點 (From Stackoverflow )](https://darrelltw.com/stackoverflow-handle-comma-and-period/?utm_source=github&utm_medium=referral)

利用 Google Tag Manager 傳送 Price 作為結構化資料或是 Google Analytics 4 時，因為逗點和小數點的問題導致價格無法順利追蹤

## [GTM - Rewrite Items In Datalayer (From Stackoverflow )](https://hexo.darrelltw.site/stackoverflow-gtm-rewrite-items-in-datalayer/?utm_source=github&utm_medium=referral)
