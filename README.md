...
### [Claude Desktop MCP 應用測試心得](https://www.darrelltw.com/claude-desktop-new-mcp-features-review/?utm_source=github_readme&utm_medium=referral)
- 發布時間: 2025/03/07
> 測試 Claude Desktop MCP(model context protocol) 的應用，包括 FileSystem、Fetch 和 Google Maps 的使用心得與注意事項，讓 Claude 幫上更多忙
...
## 📊 部落格統計
![文章總數](https://img.shields.io/badge/文章總數-83-blue?style=flat-square)
![總字數](https://img.shields.io/badge/總字數-186221+-blue?style=flat-square)
![已發布天數](https://img.shields.io/badge/已發布天數-975-blue?style=flat-square)
