...
- 發布時間: 2025/02/27
> n8n 的更新記錄，包含各版本新功能、改進和修復，和我測試的心得回饋。最新測試版本為 1.81.0，正式版本為 1.80.3
...
## 📊 部落格統計
![文章總數](https://img.shields.io/badge/文章總數-82-blue?style=flat-square)
![總字數](https://img.shields.io/badge/總字數-182146+-blue?style=flat-square)
![已發布天數](https://img.shields.io/badge/已發布天數-970-blue?style=flat-square)
