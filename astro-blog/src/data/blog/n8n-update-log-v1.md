---
title: n8n 1.0 歷史版本更新紀錄心得（0.x ~ 1.x 存檔）
pubDatetime: 2025-02-27T12:15:12+08:00
modDatetime: 2025-12-01T23:20:00+08:00
...
若要查看 **n8n 2.x 最新功能、即時版本更新與實測心得**，請前往：[n8n 版本更新紀錄心得（2.x 最新版）](/n8n-update-log/)。
{% endcallout %}
...
{% darrellImage800Alt "n8n 每個 workflow 可能有不同 path，不同 path 省下的時間不同" /n8n-update-log/n8n-1.123.0-time_saved_per_path.png max-800 %}

由於還無法開啟測試，預計也是等到下週的 **2.0 beta** 版本才能一起測試！

{% darrellImage800Alt "n8n 1.123.0 新增的 Time Saved Node 節點設定畫面，可追蹤自動化節省的時間" /n8n-update-log/n8n-1.123.0-time_saved_node.png max-800 %}

{% darrellImage800Alt "n8n 1.123.0 工作流設定中的 Time Saved Mode 功能，可設定整個工作流節省的時間" /n8n-update-log/n8n-1.123.0-time_saved_workflow_setting.png max-800 %}
...
{% darrellImage800Alt "n8n 1.123.0 Form Node 支援設定預設值，提升表單使用體驗" /n8n-update-log/n8n-1.123.0-form_node_default_values.png max-800 %}

示範截圖：

{% darrellImage800Alt "n8n 1.123.0 Form Node 支援設定預設值，示範填寫表單的結果" /n8n-update-log/n8n-1.123.0-form_node_default_values-demo.png max-400 %}
...
{% darrellImage800Alt "n8n 1.123.0 Gemini Node 新增支援 Nano Banana Pro 模型" /n8n-update-log/n8n-1.123.0-gemini_new_model.png max-400 %}
...
{% darrellImage800Alt "n8n 1.122.0 新增的 MCP Client Node 節點設定畫面" /n8n-update-log/n8n-1.122.0-mcp_client_node.png max-800 %}
...
{% darrellImage800Alt "n8n Data Tables 支援從 CSV 檔案匯入資料的功能畫面" /n8n-update-log/n8n-1.122.0-data_table_csv_import.png max-800 %}

{% darrellImage800Alt "n8n Data Tables 支援從 CSV 檔案匯入資料完成後的畫面" /n8n-update-log/n8n-1.122.0-data_table_csv_import-done-demo.png max-800 %}
...
{% darrellImage800Alt "n8n Data Tables 支援下載成 CSV 格式的功能畫面" /n8n-update-log/n8n-1.122.0-data_table_csv_download.png max-800 %}
...
{% darrellImage800Alt "n8n 表達式編輯器新增 HTML 和 Markdown 預覽功能" /n8n-update-log/n8n-1.121.0-expression_preview_html.png max-800 %}
...
{% darrellImage800Alt "n8n Data Table 新增全域搜尋功能，可快速查找資料" /n8n-update-log/n8n-1.121.0-data_table_search.png max-800 %}
...
{% darrellImage800Alt "n8n Code Node 圖示改回舊版的角括號樣式" /n8n-update-log/n8n-1.121.0-code_icon_change.png max-800 %}
...
{% darrellImage800 n8n-1.120.0-workflow_descriptions /n8n-update-log/n8n-1.120.0-workflow_descriptions.png max-800 %}
...
{% darrellImage800 n8n-1.120.0-code_node_error_message /n8n-update-log/n8n-1.120.0-code_node_error_message.png max-800 %}
...
{% darrellImage800 n8n-1.120.0-extract_from_file_skip_errors /n8n-update-log/n8n-1.120.0-extract_from_file_skip_errors.png max-800 %}
...
{% darrellImage800 n8n-1.119.0-dynamic_node_icons_using_expressions /n8n-update-log/n8n-1.119.0-dynamic_node_icons_using_expressions.png max-800 %}
...
{% darrellImage800 n8n-1.119.0-guardrails_node_add_new_node /n8n-update-log/n8n-1.119.0-guardrails_node_add_new_node.png max-800 %}

以這個設定畫面舉例，你可以選擇要檢查的規則有哪些
AI 就會先根據這個規則來依序檢查是否這個 prompt 能通過這些檢查
如果不行，就會告知哪個規則沒有通過，信心程度是多少

{% darrellImage800 n8n-1.119.0-guardrails_node_example /n8n-update-log/n8n-1.119.0-guardrails_node_example.png max-800 %}
...
{% darrellImage800 n8n-1.119.0-openai_node_add_responses_api_support_to_chat_model /n8n-update-log/n8n-1.119.0-openai_node_add_responses_api_support_to_chat_model.png max-800 %}
...
{% darrellImage800 n8n-1.119.0-openai_node_add_responses_api_support_to_chat_model_example_1 /n8n-update-log/n8n-1.119.0-openai_node_add_responses_api_support_to_chat_model_example_1.png max-800 %}

當開啟了 **Responses API** 的 **Web Search** 後
結果就不一樣了
AI 回覆：`我幫你搜尋了「...」，找到幾個相關的網路資料`

{% darrellImage800 n8n-1.119.0-openai_node_add_responses_api_support_to_chat_model_example_2 /n8n-update-log/n8n-1.119.0-openai_node_add_responses_api_support_to_chat_model_example_2.png max-800 %}
...
{% darrellImage800 n8n-1.117.0-auto_assign_credentials /n8n-update-log/n8n-1.117.0-auto_assign_credentials.png max-800 %}
...
{% darrellImage800 n8n-1.117.0-openai_v2_video /n8n-update-log/n8n-1.117.0-openai_v2_video.png max-800 %}
...
{% darrellImage800 n8n-1.117.0-import_url_validation /n8n-update-log/n8n-1.117.0-import_url_validation.png max-800 %}
...
{% darrellImage800 n8n-1.116.0-replace_node /n8n-update-log/n8n-1.116.0-replace_node.png max-800 %}
...
{% darrellImage800 n8n-1.116.0-lucide_icons /n8n-update-log/n8n-1.116.0-lucide_icons.png max-800 %}
...
{% darrellImage800 n8n-1.116.0-ai_workflow_builder /n8n-update-log/n8n-1.116.0-ai_workflow_builder.png max-800 %}
...
{% darrellImage800 n8n-1.115.0-gmail_recipients_only /n8n-update-log/n8n-1.115.0-gmail_recipients_only.png max-800 %}
...
{% darrellImage800 n8n-1.115.0-use_monospace_for_preview /n8n-update-log/n8n-1.115.0-use_monospace_for_preview.png max-800 %}
...
{% darrellImage800 n8n-1.115.0-fix_anthropic_sonnet_4_5_top_p /n8n-update-log/n8n-1.115.0-fix_anthropic_sonnet_4_5_top_p.png max-800 %}
...
{% darrellImage800 n8n-1.114.0-slack_reply_fix /n8n-update-log/n8n-1.114.0-slack_reply_fix.png max-800 %}

### Binary data access improvements
Binary Data 存取方式大改善！

{% darrellImage800 n8n-1.114.0-binary_data_improvements /n8n-update-log/n8n-1.114.0-binary_data_improvements.png max-800 %}
...
{% darrellImage800 n8n-1.114.0-node_update_button /n8n-update-log/n8n-1.114.0-node_update_button.png max-800 %}
...
{% darrellImage800 n8n-1.113.0-data_tables_default_module /n8n-update-log/n8n-1.113.0-data_tables_default_module.png max-800 %}
...
{% darrellImage800 n8n-1.113.0-node_popularity_scoring /n8n-update-log/n8n-1.113.0-node_popularity_scoring.png max-800 %}
...
{% darrellImage800 n8n-1.113.0-google_sheets_expression_warning /n8n-update-log/n8n-1.113.0-google_sheets_expression_warning.png max-800 %}
...
{% darrellImage800 n8n-1.112.0-gemini_node_add_edit_image /n8n-update-log/n8n-1.112.0-gemini_node_add_edit_image.png max-800 %}
...
{% darrellImage800 n8n-1.112.0-perplexity_node_replace_sonar_as_default_model /n8n-update-log/n8n-1.112.0-perplexity_node_replace_sonar_as_default_model.png max-800 %}
...
{% darrellImage800 n8n-1.112.0-gmail_trigger_handle_self_sent_emails /n8n-update-log/n8n-1.112.0-gmail_trigger_handle_self_sent_emails.png max-800 %}
...
{% darrellImage800 n8n-1.111.0-google_drive_shared_fix /n8n-update-log/n8n-1.111.0-google_drive_shared_fix.png max-800 %}
...
{% darrellImage800 n8n-1.111.0-wait_node_can_input_0 /n8n-update-log/n8n-1.111.0-wait_node_can_input_0.png max-800 %}
...
{% darrellImage800 n8n-1.111.0-gemini_node_support_nano_banana_model /n8n-update-log/n8n-1.111.0-gemini_node_support_nano_banana_model.png max-800 %}
...
{% darrellImage800 n8n-1.110.0-code_action_add_python /n8n-update-log/n8n-1.110.0-code_action_add_python.png max-800 %}
...
{% darrellImage800 n8n-1.110.0-http_request_add_credential_domain_limit /n8n-update-log/n8n-1.110.0-http_request_add_credential_domain_limit.png max-800 %}
...
{% darrellImage800 n8n-1.110.0-filter_toggle_fix /n8n-update-log/n8n-1.110.0-filter_toggle_fix.png max-800 %}
...
{% darrellImage800 n8n-1.109.0-fix_curl_with_comma /n8n-update-log/n8n-1.109.0-fix_curl_with_comma.png max-400 %}
...
{% darrellImage800 n8n-1.109.0-slack_reply_to_channel_optimize_wording /n8n-update-log/n8n-1.109.0-slack_reply_to_channel_optimize_wording.png max-800 %}
...
{% darrellImage800 n8n-1.109.0-slack_setting_send_to_channel /n8n-update-log/n8n-1.109.0-slack_setting_send_to_channel.png max-400 %}
...
{% darrellImage800 n8n-1.108.0-mcp_client_tool-add_timeout_config /n8n-update-log/n8n-1.108.0-mcp_client_tool-add_timeout_config.png max-400 %}
...
{% darrellImage800 n8n-1.108.0-form_add_checkbox_radiobuttons /n8n-update-log/n8n-1.108.0-form_add_checkbox_radiobuttons.png max-400 %}
...
{% darrellImage800 n8n-1.108.0-wait_add_validate_to_number_unit /n8n-update-log/n8n-1.108.0-wait_add_validate_to_number_unit.png max-800 %}
...
{% darrellImage800 n8n-1.107.0-activate_workflow_show_notification /n8n-update-log/n8n-1.107.0-activate_workflow_show_notification.png max-400 %}
...
{% darrellImage800 n8n-1.107.0-discord_oauth_custom_scopes /n8n-update-log/n8n-1.107.0-discord_oauth_custom_scopes.png max-800 %}
...
{% darrellImage800 n8n-1.107.0-sendandwait_security_token /n8n-update-log/n8n-1.107.0-sendandwait_security_token.png max-400 %}
...
{% darrellImage800 n8n-1.106.0-curl_memory_in_request_node_1 /n8n-update-log/n8n-1.106.0-curl_memory_in_request_node_1.png max-800 %}

{% darrellImage800 n8n-1.106.0-curl_memory_in_request_node_2 /n8n-update-log/n8n-1.106.0-curl_memory_in_request_node_2.png max-800 %}
...
{% darrellImage800 n8n-1.106.0-custom_input_bg_in_form /n8n-update-log/n8n-1.106.0-custom_input_bg_in_form.png max-800 %}
...
{% darrellImage800 n8n-1.106.0-google_sheet_update_empty_value /n8n-update-log/n8n-1.106.0-google_sheet_update_empty_value.png max-800 %}
...
{% darrellImage800 n8n-1.105.0-show_setting_icon_in_canva /n8n-update-log/n8n-1.105.0-show_setting_icon_in_canva.png max-800 %}

{% darrellImage800 n8n-1.105.0-show_setting_icon_in_canva_2 /n8n-update-log/n8n-1.105.0-show_setting_icon_in_canva_2.png max-800 %}
...
{% darrellImage800 n8n-1.105.0-focus_panel /n8n-update-log/n8n-1.105.0-focus_panel.png max-800 %}
...
{% darrellImage800 n8n-1.105.0-rss_custom_field /n8n-update-log/n8n-1.105.0-rss_custom_field.png max-800 %}
...
{% darrellImage800 n8n-1.104.0-new_node-anthropic /n8n-update-log/n8n-1.104.0-new_node-anthropic.png max-800 %}
...
{% darrellImage800 n8n-1.104.0-facebook_graph_api-support_v23 /n8n-update-log/n8n-1.104.0-facebook_graph_api-support_v23.png max-800 %}

### n8n Form Node: Allow basic styling of form completion message

{% darrellImage800 n8n-1.104.0-form_ending-html_support /n8n-update-log/n8n-1.104.0-form_ending-html_support.png max-800 %}
...
{% darrellImage800 n8n-1.103.0-new_node-google_gemini /n8n-update-log/n8n-1.103.0-new_node-google_gemini.png max-800 %}
...
{% darrellImage800 n8n-1.103.0-new_node-cohere_rate_limit /n8n-update-log/n8n-1.103.0-new_node-cohere_rate_limit.png max-800 %}
...
{% darrellImage800 n8n-1.103.0-new_node-cohere_chat_model /n8n-update-log/n8n-1.103.0-new_node-cohere_chat_model.png max-800 %}
...
{% darrellImage800 n8n-1.103.0-new_node-agent_tool /n8n-update-log/n8n-1.103.0-new_node-agent_tool.png max-800 %}
...
{% darrellImage800 n8n-1.102.0-add_collapse_button /n8n-update-log/n8n-1.102.0-add_collapse_button.png max-800 %}
...
{% darrellImage800 n8n-1.102.0-new_node-mistral-ai /n8n-update-log/n8n-1.102.0-new_node-mistral-ai.png max-800 %}
...
{% darrellImage800 n8n-1.102.0-google_sheet_header /n8n-update-log/n8n-1.102.0-google_sheet_header.png max-800 %}
...
{% darrellImage800 n8n-1.101.0-what_is_new_notification /n8n-update-log/n8n-1.101.0-what_is_new_notification.png max-800 %}

{% darrellImage800 n8n-1.101.0-what_is_new_notification_2 /n8n-update-log/n8n-1.101.0-what_is_new_notification_2.png max-800 %}

### Don't allow multiple active workflows with same form path

不允許多個活躍的工作流程具有相同的表單路徑

{% darrellImage800 n8n-1.101.0-form_path_can_not_be_the_same /n8n-update-log/n8n-1.101.0-form_path_can_not_be_the_same.png max-800 %}

`Form` 表單節點是可以自訂 webhook path 的
但現在跟 `webhook` 一樣，不允許多個 activate 的 path 重複

{% darrellImage800 n8n-1.101.0-form_path_can_not_be_the_same-set_path /n8n-update-log/n8n-1.101.0-form_path_can_not_be_the_same-set_path.png max-400 %}

### Support YouTube video embeds on Sticky notes
Sticky Note Node: 支援 YouTube 影片嵌入在 Sticky notes 上

{% darrellImage800 n8n-1.101.0-put_youtube_in_sticky_note /n8n-update-log/n8n-1.101.0-put_youtube_in_sticky_note.png max-800 %}
...
{% darrellImage800 n8n-1.100.0-model_selector_node /n8n-update-log/n8n-1.100.0-model_selector_node.png max-800 %}
...
{% darrellImage800 n8n-1.99.0-evaluations_add_token_metric /n8n-update-log/n8n-1.99.0-evaluations_add_token_metric.png max-800 %}

增加了在 Evaluation tab 中顯示的資訊
包含的測試時使用的 token 數

{% darrellImage800 n8n-1.99.0-evaluations_add_token_metric_2 /n8n-update-log/n8n-1.99.0-evaluations_add_token_metric_2.png max-800 %}


### MCP Server Trigger Node: Support for Streamable HTTP transport in MCP Server

{% darrellImage800 n8n-1.99.0-mcp_server_add_support_http_streamtable /n8n-update-log/n8n-1.99.0-mcp_server_add_support_http_streamtable.png max-800 %}
...
{% darrellImage800 n8n-1.99.0-node_name_will_change_automatically_based_on_action /n8n-update-log/n8n-1.99.0-node_name_will_change_automatically_based_on_action.png max-800 %}
...
{% darrellImage800 n8n-1.98.0-add_filter_in_n8n_node /n8n-update-log/n8n-1.98.0-add_filter_in_n8n_node.png max-800 %}
...
{% darrellImage800 n8n-1.98.0-fix_rss_node /n8n-update-log/n8n-1.98.0-fix_rss_node.png max-800 %}
...
{% darrellImage800 n8n-1.98.0-gpt_4.1_mini_model_compare_4o_mini /n8n-update-log/n8n-1.98.0-gpt_4.1_mini_model_compare_4o_mini.png max-800 %}

4.1 mini 算是比 4o-mini 貴了一些，但在調用模型的能力上應該強大不少，另外 context 也達到一百萬
在上下文的理解上強大很多


{% darrellImage800 n8n-1.98.0-default_gpt_4.1_mini_model /n8n-update-log/n8n-1.98.0-default_gpt_4.1_mini_model.png max-800 %}
...
{% darrellImage800 n8n-1.98.0-structure_output_add_auto_fix /n8n-update-log/n8n-1.98.0-structure_output_add_auto_fix.png max-800 %}

這是個有開啟 Output Parser 和沒有的差異 demo

{% darrellImage800 n8n-1.98.0-structure_output_demo /n8n-update-log/n8n-1.98.0-structure_output_demo.png max-800 %}
...
{% darrellImage800 n8n-1.96.0-new_perplexity_node /n8n-update-log/n8n-1.96.0-new_perplexity_node.png max-800 %}

{% darrellImage800 n8n-1.96.0-perplexity_node_result /n8n-update-log/n8n-1.96.0-perplexity_node_result.png max-800 %}
...
{% darrellImage800 n8n-1.96.0-perplexity_models /n8n-update-log/n8n-1.96.0-perplexity_models.png max-800 %}
...
{% darrellImage800 n8n-1.96.0-custom_output_path /n8n-update-log/n8n-1.96.0-custom_output_path.png max-800 %}
...
{% darrellImage800 n8n-1.95.0-anthropic_default_4_sonnet /n8n-update-log/n8n-1.95.0-anthropic_default_4_sonnet.png max-800 %}
...
{% darrellImage800 n8n-1.95.0-show_execute_status_in_output /n8n-update-log/n8n-1.95.0-show_execute_status_in_output.png max-800 %}
...
{% darrellImage800 n8n-1.94.0-microsoft_teams_node_new_trigger_actions /n8n-update-log/n8n-1.94.0-microsoft_teams_node_new_trigger_actions.png max-800 %}

### feat(editor): Keyboard shortcuts for the log view

Log Panel 中新增了快捷鍵

{% darrellImage800 n8n-1.94.0-log_panel_add_shortcuts /n8n-update-log/n8n-1.94.0-log_panel_add_shortcuts.png max-800 %}
...
{% darrellImage800 n8n-1.94.0-log_shows_subworkflow_execution /n8n-update-log/n8n-1.94.0-log_shows_subworkflow_execution.png max-800 %}
...
{% darrellImage800 n8n-1.94.0-subworkflow_accept_binary /n8n-update-log/n8n-1.94.0-subworkflow_accept_binary.png max-800 %}
...
{% darrellImage800 n8n-1.93.0-show_community_node_in_search /n8n-update-log/n8n-1.93.0-show_community_node_in_search.png max-800 %}
...
{% darrellImage800 n8n-1.93.0-soft_delete_archived /n8n-update-log/n8n-1.93.0-soft_delete_archived.png max-800 %}
...
{% darrellImage800 n8n-1.93.0-open_subworkflow_quickly /n8n-update-log/n8n-1.93.0-open_subworkflow_quickly.png max-800 %}
...
{% darrellImage800 n8n-1.93.0-share_with_you_section /n8n-update-log/n8n-1.93.0-share_with_you_section.png max-800 %}
...
{% darrellImage800 n8n-1.92.0-manual_trigger /n8n-update-log/n8n-1.92.0-manual_trigger.png max-800 %}
...
(借用官方 issue 的圖片)
{% darrellImage800 n8n-1.92.0-curl_import_fix_for_special_character /n8n-update-log/n8n-1.92.0-curl_import_fix_for_special_character.png max-800 %}
...
{% darrellImage800 n8n-1.92.0-log_panel_rendered /n8n-update-log/n8n-1.92.0-log_panel_rendered.png max-800 %}
...
{% darrellImage800 n8n-1.92.0-setting_env_for_logs /n8n-update-log/n8n-1.92.0-setting_env_for_logs.png max-800 %}
...
{% darrellImage800 n8n-1.91.0-chatgpt_generate_image_1_model_in_openai_node /n8n-update-log/n8n-1.91.0-chatgpt_generate_image_1_model_in_openai_node.jpg max-800 %}
...
{% darrellImage800 n8n-1.91.0-chatgpt_generate_image_1_model_in_openai_node_options_error /n8n-update-log/n8n-1.91.0-chatgpt_generate_image_1_model_in_openai_node_options_error.png max-400 %}
...
{% darrellImage800 n8n-1.91.0-sheet_trigger_fix /n8n-update-log/n8n-1.91.0-sheet_trigger_fix.png max-400 %}
...
{% darrellImage800 n8n-1.91.0-insight_date_range_options /n8n-update-log/n8n-1.91.0-insight_date_range_options.png max-400 %}
...
{% darrellImage800 n8n-1.91.0-open_node_editor_with_url /n8n-update-log/n8n-1.91.0-open_node_editor_with_url.png max-400 %}
...
{% darrellImage800 n8n-1.91.0-prevent_webhook_url_takeover /n8n-update-log/n8n-1.91.0-prevent_webhook_url_takeover.png max-800 %}
...
{% darrellImage800 n8n-1.90.0-api_scope /n8n-update-log/n8n-1.90.0-api_scope.png max-800 %}
...
{% darrellImage800 n8n-1.90.0-logs_show_for_execution /n8n-update-log/n8n-1.90.0-logs_show_for_execution.png max-800 %}
...
{% darrellImage800 n8n-1.90.0-add_request_tool_node /n8n-update-log/n8n-1.90.0-add_request_tool_node.png max-800 %}
...
{% darrellImage800 n8n-1.89.0-xai_grok_fix_parameter /n8n-update-log/n8n-1.89.0-xai_grok_fix_parameter.png max-400 %}

### editor: Add telemetry to Insights

蠻有趣的更新，開始追蹤使用者使用 Insights 的狀況

{% darrellImage800 n8n-1.89.0-track_user_using_insights /n8n-update-log/n8n-1.89.0-track_user_using_insights.png max-400 %}
...
{% darrellImage800 n8n-1.89.0-logs_for_all_node /n8n-update-log/n8n-1.89.0-logs_for_all_node.png max-400 %}
...
{% darrellImage800 n8n-1.88.0-mcp_server_client /n8n-update-log/n8n-1.88.0-mcp_server_client.png max-800 %}
...
{% darrellImage800 n8n-1.88.0-mcp_sse_vs_stdio /n8n-update-log/n8n-1.88.0-mcp_sse_vs_stdio.png max-800 %}
...
{% darrellImage800 n8n-1.87.1-insights_shows_up /n8n-update-log/n8n-1.87.1-insights_shows_up.png max-800 %}
...
{% darrellImage800 n8n-1.87.1-enable_insights_in_zeabur /n8n-update-log/n8n-1.87.1-enable_insights_in_zeabur.png max-800 %}
...
{% darrellImage800 n8n-1.87.1-workflow_setting_time_saved /n8n-update-log/n8n-1.87.1-workflow_setting_time_saved.png max-800 %}
...
{% darrellImage800 n8n-1.87.1-think_tool /n8n-update-log/n8n-1.87.1-think_tool.jpg max-800 %}
...
{% darrellImage800 n8n-1.87.1-think_tool_vs_extend_thinking /n8n-update-log/n8n-1.87.1-think_tool_vs_extend_thinking.png max-400 %}
...
{% darrellImage800 n8n-1.85.0-folder /n8n-update-log/n8n-1.85.0-folder.png max-400 %}
...
{% darrellImage800 n8n-1.85.0-folder_need_registered /n8n-update-log/n8n-1.85.0-folder_need_registered.png max-400 %}
...
{% darrellImage800 n8n-1.85.0-time_save_per_execution /n8n-update-log/n8n-1.85.0-time_save_per_execution.png max-800 %}
...
{% darrellImage800 n8n-1.85.0-var_in_context /n8n-update-log/n8n-1.85.0-var_in_context.png max-400 %}
...
{% darrellImage800 n8n-1.85.0-send_and_wait_append_n8n /n8n-update-log/n8n-1.85.0-send_and_wait_append_n8n.png max-400 %}
...
{% darrellImage800 n8n-1.85.0-delete_community_node_in_command_line /n8n-update-log/n8n-1.85.0-delete_community_node_in_command_line.png max-400 %}
...
現在可以將日誌視窗彈出到獨立視窗中檢視，方便在處理複雜工作流程時同時監控運行情況
   {% darrellImage800 n8n-1.84.0-log_popup /n8n-update-log/n8n-1.84.0-log_popup.png max-800 %}
...
新增可選擇退出訊息狀態更新的選項，讓使用者有更多控制權
   {% darrellImage800 n8n-1.84.0-whatsapp /n8n-update-log/n8n-1.84.0-whatsapp.png max-800 %}
...
{% darrellImage800 n8n-1.83.0-unpin /n8n-update-log/n8n-1.83.0-unpin.png max-400 %}

2. Error view 現在可以完整寬度檢視
3. 貼上 `=test1234` 後會維持 `=test1234`，原本會因為判定成 expression 所以變成 test1234

{% darrellImage800 n8n-1.83.0-equals /n8n-update-log/n8n-1.83.0-equals.png max-400 %}

4. 有些狀況 (沒 focus 到，Expression 全螢幕修改時) 用 ctrl+s 無法存檔，已調整優化

{% darrellImage800 n8n-1.83.0-save /n8n-update-log/n8n-1.83.0-save.png max-400 %}
...
{% darrellImage800 n8n-1.82.0-azure_storage.png /n8n-update-log/n8n-1.82.0-azure_storage.png max-400 %}
...
{% darrellImage800 n8n-1.82.0-node_modity /n8n-update-log/n8n-1.82.0-node_modity.png max-800 %}
...
{% darrellImage800 n8n-1.82.0-chnage_to_expression_automatically.png /n8n-update-log/n8n-1.82.0-chnage_to_expression_automatically.png max-800 %}
...
{% darrellImage800 n8n_update-n8n_folder_preview /n8n-update-log/n8n_update-n8n_folder_preview.png max-800 %}
