...
最近熱門的 **First Party Cookie** 和 **Third Party Cookie**
以及 Cookie Consent 等等都和 Cookie 有關
主要是隱私權的抬頭讓大家開始在意那瀏覽器到底記住了哪些關於我的資訊
這個 Cookie 是為了分析的需求? 還是為了記憶我的登入資訊? 或是廣告做再行銷的用途等等
...
**網站速度**需要長期的努力和做出很多相對應的取捨
並且要維持固定檢查的習慣
大家為了滿足使用者的需求往往會增加更多的網站功能或套件
這些新的功能因為需要額外的載入或是資源，相對應的可能就會增加讀取的時間
